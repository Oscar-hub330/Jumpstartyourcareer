...
// Lazy load heavy component (carousel)
...
// Memoized card for success stories
...
const Home = () => {
  ...
  // Memoize focusAreas so it doesn't get recreated on every render
  ...
  // Memoize generated success stories, re-generate only when needed
  const [successStories, setSuccessStories] = useState(() => generateSuccessStories(6));

  // Handler to regenerate success stories on button click
    ...
    >
      ...
      >
        ...
        <Box
          ...
          mx="auto"
        >
          <TextField label="Email Address" variant="outlined" size="small" fullWidth sx={{ bgcolor: "#fff" }} />
